...
* [CHANGE] Alertmanager: added built-in configuration so that `-alertmanager.configs.fallback` is not explicitly needed anymore if no configuration is provided for a tenant. #2772
